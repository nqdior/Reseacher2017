...
namespace newtype.Database
{
    ...
    public class SqlConnecter
    {
        ...
        /// DB情報構造体
        /// </summary>
        public DBProvider DBinfo { get; set; }

        /// <summary>
        /// DB(SQLSV)の情報構造体：trn 
        /// </summary>
        private SqlTransaction transact { get; set; } = null;
        ...
        /// コンストラクタ
        /// </summary>
        public SqlConnecter(DBProvider DBinfo)
        {
            this.DBinfo = DBinfo;
        }
        #endregion
        ...
        public bool ConnectToSQLServer(Connection connection, bool isMsgShow = false, 
